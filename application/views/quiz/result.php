                   ...
                   <div class="card-content">
                       <!-- <h4 class="card-title col-md-4"> -->
                           <div class="form-group col-md-2" style="margin:21PX 0PX;padding-bottom:0PX;">
                               <input id="search_input" name="search_input" type="text" class="form-control " placeholder="Search" required value="<?php echo $search;?>">
                           </div>
                       <!-- </h4> -->
                       <div class="panel panel-default panel-rose col-md-3">
                           ...
                           <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                               <div class="panel-body">
                                        <div class="checkbox">
                                            <label>
                                                <input id="ALL" type="checkbox" value="" data-toggle="checkbox" <?php if($check_category=='') echo 'checked';?>>
                                                All
                                            </label>
                                        </div>
                                        <?php
                                        $check_category = explode(',', $check_category);
                                            for($i=0;$i<count($category);$i++)
                                            {
                                                $checked="";
                                                for($j=0;$j<count($check_category);$j++){
                                                    if($category[$i]['id']==$check_category[$j])
                                                    $checked="checked";
                                                }
                       ...
                       <div class="panel panel-default panel-rose col-md-3">
                           ...
                           <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                              <div class="panel-body">
                                       <div class="checkbox">
                                           <label>
                                               <input id="ALL" type="checkbox" value="" data-toggle="checkbox" <?php if($check_type=='') echo 'checked';?>>
                                               All
                                           </label>
                                       </div>
                                       <?php
                                        $check_type = explode(',', $check_type);
                                            ...
                                            {
                                                $checked="";
                                                for($j=0;$j<count($check_type);$j++){
                                                    if($type[$i]['id']==$check_type[$j])
                                                    $checked="checked";
                                                }
                                                    echo "<div class='checkbox'>
                                                        <label>
                                                            <input type='checkbox' id='".$type[$i]['id']. "' value='".$type[$i]['id']. "' data-toggle='checkbox' $checked>
                                                                ".$type[$i]['name']."
                                                        </label>
                                                      </div>";
                                            }
                       ...
                       <div class="panel panel-default panel-rose col-md-3">
                           ...
                           <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                               <div class="panel-body">
                                       <div class="checkbox">
                                           <label>
                                               <input id="ALL" type="checkbox" value="" data-toggle="checkbox" value="" <?php if($check_groups=='') echo 'checked';?>>
                                               All
                                          </label>
                                       </div>
                                        <?php
                                        $check_groups = explode(',', $check_groups);
                                            for($i=0;$i<count($groups);$i++)
                                            {
                                                ...
                                                for($j=0;$j<count($check_groups);$j++){
                                                    if($groups[$i]['id']==$check_groups[$j])
                                                    $checked="checked";
                                                }
                                                    echo "<div class='checkbox'>
                                                        <label>
                                                            <input type='checkbox' id='".$groups[$i]['id']. "' value='".$groups[$i]['id']. "' data-toggle='checkbox' $checked>
                                                                ".$groups[$i]['name']."
                                                        </label>
                                                      </div>";
                                            }
                ...
                <div class="card card-profile" id="<?php echo $quiz[$i]['id']?>">
                  ...
                  <div class="card-content">
                    ...
                    <div class="footer" style="">
                        ...
                        <a href="<?php echo base_url().'quiz/quiz_full_details/'.$quiz[$i]['id']?>" class="btn btn-info btn-round" style="margin-left: 15%;" id="<?php echo $quiz[$i]['id']?>">Play</a>
                  </div>
                </div>
             <?php } ?>
             </div>
